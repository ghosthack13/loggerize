...
*	@return {string[]} - an array of the names of the handles that were added
*/
function addHandle(){
...
*	@return {string[]} - an array of the names of the targets that were added
*/
function addTarget(){
...
*	@throws {TypeError} Argument name must be of type object
*	@throws {TypeError} Argument func must be of type function
*	@return {string[]} - an array of the names of the filters that were added
*/
function addFilter(){
...
*	@throws {TypeError} Argument name must be of type object
*	@throws {TypeError} Argument func must be of type function
*	@return {string[]} - an array of the names of the transformers that were added
*/
