...
function ANSIStyler(input, styleOpts){
	...
	let textDecorators = [];
	let sequenceIntroducer = "\033[";
	let sequenceTerminator = "\033[0m";
	...
	return sequenceIntroducer + textDecorators.join(';') + "m" + input + sequenceTerminator;
}


function test(){
	let myStyle = parseStyle("red bgYellowBright");
	console.log(myStyle);
}
