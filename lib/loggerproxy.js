...
*	@function setLevelMapper
*	@param {string} levelMapper - Name of the level mapper you wish to set
*	@throws {Error} Throws error if levelMapper is not defined
*/
...
/** Get the name of the severity level of the first logger that produces output
...
/**	Dettach a defined filter to the logger
...
*	@returns {function} HTTP/Connect compatible middleware
*	@throws {Error} Throws error if logger is not an HTTP logger
*/
