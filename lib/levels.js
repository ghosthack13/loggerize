...
var DEFAULT_LEVEL_COLORS = {
	...
	"syslog": {
		...
		"debug": 	{"font": {"color": "cyan",  "modifiers": ["bold"]}},
...
function setLevel(level){
	if (!this.levelMappings[this.levelMapper].hasOwnProperty(level)){
...
function colorizeLevels(colorMap, levelMapper){
	...
	Object.defineProperty(this.formatters["_level"], "style", {
		writable: true,
		enumerable: true, 
		configurable:true,
		value: {}, 
	...
	if (typeof(colorMap) == "undefined"){
		this.formatters["_level"]["style"] = DEFAULT_LEVEL_COLORS;
		return;
	}
	...
	if (typeof(colorMap) == "object" && !Array.isArray(colorMap)){
		this.formatters["_level"]["style"][levelMapper] = {};
		for (levelName in colorMap){
			this.formatters["_level"]["style"][levelMapper][levelName] = styler.parseStyle(colorMap[levelName]);
		}
	}
}
function decolorizeLevels(levelMapper){
	...
	if (typeof(levelMapper) == "undefined"){
		delete this.formatters["_level"]["style"];
		return;
	}
